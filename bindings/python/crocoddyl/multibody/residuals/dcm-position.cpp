...
void exposeResidualDCMPosition() {
  ...
  bp::class_<ResidualModelDCMPosition, bp::bases<ResidualModelAbstract> >(
      ...
      "This residual function defines the DCM tracking as r = c - cref, with c and cref as the current and reference "
      "DCM position, respectively.",
      bp::init<boost::shared_ptr<StateMultibody>, Eigen::Vector3d, std::size_t, double>(
          bp::args("self", "state", "cref", "nu", "alpha"),
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, Eigen::Vector3d, double>(
          ...
          ":param alpha: inverse of the time constant"))
      .def<void (ResidualModelDCMPosition::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                              const Eigen::Ref<const Eigen::VectorXd>&,
                                              const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calc", &ResidualModelDCMPosition::calc, bp::args("self", "data", "x", "u"),
      ...
      .def<void (ResidualModelDCMPosition::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                              const Eigen::Ref<const Eigen::VectorXd>&,
                                              const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff", &ResidualModelDCMPosition::calcDiff, bp::args("self", "data", "x", "u"),
      ...
      .def("createData", &ResidualModelDCMPosition::createData, bp::with_custodian_and_ward_postcall<0, 2>(),
           bp::args("self", "data"),
      ...
      .add_property("reference",
                    bp::make_function(&ResidualModelDCMPosition::get_reference, bp::return_internal_reference<>()),
                    &ResidualModelDCMPosition::set_reference, "reference DCM position");
  ...
  bp::class_<ResidualDataDCMPosition, bp::bases<ResidualDataAbstract> >(
      ...
      .add_property("pinocchio",
                    bp::make_getter(&ResidualDataDCMPosition::pinocchio, bp::return_internal_reference<>()),
                    "pinocchio data");
}
