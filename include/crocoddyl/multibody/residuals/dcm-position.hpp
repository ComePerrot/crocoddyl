...
#ifndef CROCODDYL_MULTIBODY_RESIDUALS_DCM_POSITION_HPP_
#define CROCODDYL_MULTIBODY_RESIDUALS_DCM_POSITION_HPP_
...
class ResidualModelDCMPositionTpl : public ResidualModelAbstractTpl<_Scalar> {
 public:
   ...
   */
  ResidualModelDCMPositionTpl(boost::shared_ptr<StateMultibody> state, const Vector3s& cref, const std::size_t nu, const double alpha);
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include "crocoddyl/multibody/residuals/dcm-position.hxx"

#endif  // CROCODDYL_MULTIBODY_RESIDUALS_DCM_POSITION_HPP_
