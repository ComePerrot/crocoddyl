...
#ifndef CROCODDYL_MULTIBODY_RESIDUALS_ANTICIPATED_STATE_HPP_
#define CROCODDYL_MULTIBODY_RESIDUALS_ANTICIPATED_STATE_HPP_
...
class ResidualModelAnticipatedStateTpl : public ResidualModelAbstractTpl<_Scalar> {
 public:
   ...
   */
  ResidualModelAnticipatedStateTpl(boost::shared_ptr<typename Base::StateAbstract> state, const std::size_t nu,
   ...
   * @param[in] xref        Reference state
   */
  ResidualModelAnticipatedStateTpl(boost::shared_ptr<typename Base::StateAbstract> state, const double& anticipated_time);
...
struct ResidualDataAnticipatedStateTpl : public ResidualDataAbstractTpl<_Scalar> {
  ...
  ResidualDataAnticipatedStateTpl(Model<Scalar>* const model, DataCollectorAbstract* const data)
      : Base(model, data), Jx(model->get_state()->get_ndx(),model->get_state()->get_ndx()) {
    Jx.setZero();
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include "crocoddyl/multibody/residuals/anticipated-state.hxx"
